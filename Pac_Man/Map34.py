...
class Map:  
    def __init__(self, ai_game):
        ...
        self.wall_path = os.path.join(current_dir,'images','wall.png')
        self.power_path = os.path.join(current_dir,'images','power.png')
        # Convert char to image
        # 1: wall
        # 2: Goal (Large Food)
        self.char_to_image = {
            1: pygame.transform.scale(pygame.image.load(self.wall_path), (25,25)),
            2: pygame.transform.scale(pygame.image.load(self.power_path), (25,25)),
        }
